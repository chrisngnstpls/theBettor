...
contract Bet {
    ...
    modifier differenceOk {
        require(block.number - 5 < blockNumber);
        _;
    }

    modifier feeOk {
        require(fee <= highestFee && fee >= lowestFee);
        _;
    }
    ...
    function agreedCancel() public differenceOk {
    ...
    function resolveBet(address payable _winner) public onlyOwner feeOk {
